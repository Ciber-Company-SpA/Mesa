-- ============================================================================
-- get_public_menu: incluir created_at en cada producto.
--
-- Bug: el menú del cliente marca como "Nuevo" los productos creados en los
-- últimos 7 días (isNewProduct usa product.created_at), pero la RPC no devolvía
-- created_at, así que el badge "Nuevo" nunca aparecía. Se agrega el campo
-- (idéntica a la versión anterior, solo sumando created_at).
-- ============================================================================
