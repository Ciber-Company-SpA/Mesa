-- ============================================================================
-- get_public_menu: incluir variant_image en cada variante.
--
-- Bug: el detalle de producto del cliente cambia la imagen al elegir una
-- variante (activeImage = variant.variant_image ?? product.product_image),
-- pero la RPC del menú NO devolvía variant_image, así que siempre era null y
-- la imagen nunca cambiaba. Se agrega el campo (idéntica a la versión anterior,
-- solo sumando variant_image).
-- ============================================================================
