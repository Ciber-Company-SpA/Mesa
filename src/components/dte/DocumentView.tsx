...
/**
 * Representación imprimible de un documento tributario. Se usa igual en la
 * página /documento/[id] y en el modal de vista previa. El contenedor lleva
 * data-print-root para que, al imprimir, se muestre solo el documento.
 */
    ...
    >
      ...
      {doc.receptorRut || doc.receptorRazon ? (
        <div className="mt-5 rounded-lg bg-stone-50 px-4 py-3 text-xs text-stone-700">
          ...
          <p className="mt-1">
            {doc.receptorRazon ?? "—"}
            {doc.receptorRut ? ` · RUT ${doc.receptorRut}` : ""}
          </p>
        </div>
      ) : null}
